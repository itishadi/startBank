...
using static BankLibrary.Services.AccountService;
using System.Transactions;
using startBank.BankAppDatas;
using startBank.Models;
using static BankLibrary.Services.IAccountService;
...
namespace BankLibrary.Services
{
    public class AccountService : IAccountService
    {
            ...
            public ErrorMessage Withdraw(int accountId, decimal amount)
            {
                ...
                var transaction = new startBank.BankAppDatas.Transaction
                {
                    AccountId = accountId,
                    Date = DateTime.Now,
                    Operation = "Withdraw",
            ...
            public ErrorMessage Transaction(int fromAccountId, int toAccountId, decimal amount)
            {
                ...
                var transactionFrom = new startBank.BankAppDatas.Transaction
                {
                ...
                var transactionTo = new startBank.BankAppDatas.Transaction
                {
